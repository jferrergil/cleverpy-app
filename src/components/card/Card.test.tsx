...
describe("Given the component Card", () => {
    describe('When it recieves some props', () => { 
        test("It renders information given", () => {
            const mockPost: Post = {id: 1, body: "This is a test body", title: "This is a test title", userId: 1};
            const mockFunction = jest.fn();

            render(<Card post={mockPost} func={mockFunction}/>)

            expect(screen.getByRole("heading", {name: "This is a test title"})).toBeInTheDocument();
